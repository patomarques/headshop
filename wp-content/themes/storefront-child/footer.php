    ...
    <div class="row footer-row">
      ...
      <div class="col-12 col-md-6 col-lg-3">
        ...
        <div class="footer-payment-logos">
          ...
          $all_svgs = eletronicos_payment_logos_svg();
          foreach ( $payment_logos as $logo ) :
            $thumb = get_the_post_thumbnail_url( $logo->ID, 'medium' );
            $key   = get_post_meta( $logo->ID, '_asaas_key', true );
            if ( $thumb ) : ?>
              <img src="<?php echo esc_url( $thumb ); ?>" alt="<?php echo esc_attr( $logo->post_title ); ?>">
            <?php elseif ( $key && isset( $all_svgs[ $key ] ) ) : ?>
              <span class="payment-svg" title="<?php echo esc_attr( $logo->post_title ); ?>"><?php echo $all_svgs[ $key ]; ?></span>
            <?php endif;
          endforeach; ?>
        </div>
      </div>
